...
export const practiceTiles: PracticeTile[] = [
  // Microbiology (subjectId: 1)
  { id: 1, subjectId: 1, title: "Cell Structure Quiz", questions: 15, difficulty: "Easy", color: "bg-navy-800", imageUrl: "https://images.unsplash.com/photo-1518152006812-edab29b069ac?w=400&h=300&fit=crop" },
  { id: 2, subjectId: 1, title: "Bacterial Identification", questions: 20, difficulty: "Medium", color: "bg-navy-900", imageUrl: "https://images.unsplash.com/photo-1576086213369-97a306d36557?w=400&h=300&fit=crop" },
  { id: 3, subjectId: 1, title: "Virology Concepts", questions: 12, difficulty: "Hard", color: "bg-navy-800", imageUrl: "https://images.unsplash.com/photo-1584036561566-baf8f5f1b144?w=400&h=300&fit=crop" },
  { id: 4, subjectId: 1, title: "Antibiotic Mechanisms", questions: 18, difficulty: "Medium", color: "bg-navy-900", imageUrl: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400&h=300&fit=crop" },
  { id: 5, subjectId: 1, title: "Immune Response", questions: 10, difficulty: "Easy", color: "bg-navy-800", imageUrl: "https://images.unsplash.com/photo-1579154204601-01588f351e67?w=400&h=300&fit=crop" },
  // Chemistry (subjectId: 2)
  { id: 6, subjectId: 2, title: "Periodic Table Quiz", questions: 25, difficulty: "Easy", color: "bg-navy-800", imageUrl: "https://images.unsplash.com/photo-1532634922-8fe0b757fb13?w=400&h=300&fit=crop" },
  { id: 7, subjectId: 2, title: "Balancing Equations", questions: 20, difficulty: "Medium", color: "bg-navy-900", imageUrl: "https://images.unsplash.com/photo-1603126857599-f6e157fa2fe6?w=400&h=300&fit=crop" },
  { id: 8, subjectId: 2, title: "Organic Compounds", questions: 18, difficulty: "Hard", color: "bg-navy-800", imageUrl: "https://images.unsplash.com/photo-1616400619175-5beda3a17896?w=400&h=300&fit=crop" },
  { id: 9, subjectId: 2, title: "Acid-Base Reactions", questions: 15, difficulty: "Medium", color: "bg-navy-900", imageUrl: "https://images.unsplash.com/photo-1554475901-4538ddfbccc2?w=400&h=300&fit=crop" },
  // Biology (subjectId: 3)
  { id: 10, subjectId: 3, title: "Cell Biology Basics", questions: 20, difficulty: "Easy", color: "bg-navy-800", imageUrl: "https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=400&h=300&fit=crop" },
  { id: 11, subjectId: 3, title: "Genetics & Heredity", questions: 22, difficulty: "Medium", color: "bg-navy-900", imageUrl: "https://images.unsplash.com/photo-1628595351029-c2bf17511435?w=400&h=300&fit=crop" },
  { id: 12, subjectId: 3, title: "Ecosystem Dynamics", questions: 15, difficulty: "Medium", color: "bg-navy-800", imageUrl: "https://images.unsplash.com/photo-1446071103084-c257b5f70672?w=400&h=300&fit=crop" },
  { id: 13, subjectId: 3, title: "Human Body Systems", questions: 30, difficulty: "Hard", color: "bg-navy-900", imageUrl: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&h=300&fit=crop" },
];
